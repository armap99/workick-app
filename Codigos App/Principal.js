...
export default class Principal extends Component {
  ...
  componentDidMount = async () => {
    ...
    xhttpD.open(
      'GET',
      'https://workick.000webhostapp.com/PhpMovil/VerTrabajadores.php?opcion=1',
      true,
    );
    xhttpD.send();
  };
  ...
  Buscar = () => {
    ...
    xhttp.open(
      'GET',
      'https://workick.000webhostapp.com/PhpMovil/FiltroTrabajadores.php?municipio=' +
        ...
        return (
          <View>
            <MenuDrawer
              ...
              <ScrollView style={{marginBottom: 30}}>
                <Recomendaciones
                  navigation={this.props.navigation}></Recomendaciones>
                {this.state.trabajos.map((trabajos, index) => (
                  <Trabajador
                    key={index}
                    Id1={trabajos.Id}
